...
import { Bar, BarChart, CartesianGrid, Cell, Legend, Line, LineChart, Pie, PieChart, PolarAngleAxis, PolarGrid, Radar, RadarChart, ResponsiveContainer, Sector, Tooltip, XAxis, YAxis } from 'recharts';
...
const GraphContainer: FunctionComponent<IProps> = (props: IProps) => {
 ...
 const ActiviteDiag = useMemo(() => {
  if (props.user) {
   ...
   return (<BarChart width={750} height={250} data={data}>
